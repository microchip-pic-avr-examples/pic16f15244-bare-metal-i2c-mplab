...
#ifndef MSSP1_BLOCKDATA_H
#define	MSSP1_BLOCKDATA_H
...
#define FIRST_BYTE_ADDR
    ...
    /**
     * <b><FONT COLOR=BLUE>void</FONT> _MSSP_StoreByte(<FONT COLOR=BLUE>uint8_t</FONT> data)</B>
    ...
    /**
     * <b><FONT COLOR=BLUE>uint8_t</FONT> _MSSP_RequestByte(<FONT COLOR=BLUE>void</FONT>)</B>
     * 
    ...
    /**
     * <b><FONT COLOR=BLUE>void</FONT> _onMSSPStop(<FONT COLOR=BLUE>void</FONT>)</B>
     * 
